    ...
    class Import < ApplicationService
      ...
      def fetch_subject
        ...
        sync_subjects(
          ...
          subjects_data:,
          parent_subject: PlacementSubject.find_by(name: "Modern Languages"),
        )
      end
      ...
      def sync_subjects(subject_area:, subject_ids:, subjects_data:, parent_subject: nil)
        ...
        subject_area_subjects_data.each do |subject_data|
          ...
          begin
            subject = PlacementSubject.find_or_create_by!(
              phase: subject_area,
            ...
            Rails.logger.error "Invalid placement subject #{subject_data}"
          end
        end
      end
