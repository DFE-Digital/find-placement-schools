  ...
  describe "scopes" do
    describe "order_by_date_desc" do
      ...
      it "orders by starts_on date in ascending order" do
        expect(described_class.where.not(id: academic_year_ids_to_exclude).order_by_date_desc).to eq([ academic_year_4, academic_year_3, academic_year_2, academic_year_1 ])
      end
    end
  end
  ...
  describe ".current" do
    ...
    it "returns the academic year for the current date" do
      Timecop.travel(Date.parse("5 December 2020")) do
        expect(described_class.current).to eq(academic_year)
      end
    end
  end
  ...
  describe ".next" do
    let!(:next_academic_year) do
      create(:academic_year,
             ...
             ends_on: Date.parse("31 August 2022"),
             name: "2021 to 2022")
    end
