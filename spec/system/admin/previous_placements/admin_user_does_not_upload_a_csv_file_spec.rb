...
RSpec.describe "Admin user does not upload a CSV file", type: :system do
  scenario do
    ...
    then_i_see_an_error_message_for_uploading_an_invalid_file_type
  end
  ...
  def when_i_upload_an_invalid_file
    attach_file "Upload CSV file", "spec/rails_helper.rb"
  end
  ...
  def then_i_see_an_error_message_for_uploading_an_invalid_file_type
