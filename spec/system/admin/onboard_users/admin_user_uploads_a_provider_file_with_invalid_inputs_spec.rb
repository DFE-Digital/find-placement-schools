...
RSpec.describe "Admin user uploads a provider file with invalid inputs", type: :system do
  scenario do
  ...
  def then_i_see_the_errors_page
    ...
    expect(page).to have_element(:td, text: "Enter a valid email address", class: "govuk-table__cell", count: 4)
