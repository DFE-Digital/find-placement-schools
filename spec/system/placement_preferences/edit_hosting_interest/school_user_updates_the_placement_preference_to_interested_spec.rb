...
RSpec.describe "School user updates the placement preference to interest", type: :system do
  scenario do
  ...
  def then_i_see_the_school_is_not_offering_placements
    ...
    expect(page).to have_link(
      ...
      href: new_edit_hosting_interest_placement_preference_path(@placement_preference, academic_year_id: @next_academic_year.id),
    )
